...
public class AutoCallBackConnection implements Connection{
    ...
    private ConnectionDirtyCache cache=new ConnectionDirtyCache();
    ...
    public void commit() throws SQLException {
        if(cacheManager!=null&&cache.size()>0){
            //DirtyUtils.writeCache(cacheManager,cache);
            cacheManager.clear();
            logger.info("clear all cache,because data is updated");
        }
    ...
    public ConnectionDirtyCache getCache() {
        return cache;
    }
