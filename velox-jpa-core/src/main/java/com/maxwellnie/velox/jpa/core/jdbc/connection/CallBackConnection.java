package com.maxwellnie.velox.jpa.core.jdbc.connection;
...
public class CallBackConnection implements Connection {
    private static Logger logger = LoggerFactory.getLogger(CallBackConnection.class);
    private final Connection connection;
    private final ConnectionPool pool;

    private boolean isClosed = false;

    public CallBackConnection(Connection connection, ConnectionPool pool) {
