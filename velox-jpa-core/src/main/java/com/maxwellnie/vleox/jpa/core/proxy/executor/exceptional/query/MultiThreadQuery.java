...
import com.maxwellnie.vleox.jpa.core.exception.ThreadPoolException;
import com.maxwellnie.vleox.jpa.core.jdbc.sql.LimitFragment;
...
public class MultiThreadQuery {
    ...
    public MultiThreadQuery(int cpuCore, DataSource dataSource) {
    ...
    public <E> void execute(SqlBuilder<E> sqlBuilder, QueryHandle<E> queryHandle, Class<E> clazz) throws SQLException {
        TableInfo tableInfo = ReflectUtils.getTableInfo(clazz);
